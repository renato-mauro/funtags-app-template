(function (factory) {
    ...
    const { div: div$1, ul, li, a: a$1, button, style } = ft.html;
    ...
    function sideBarCollapsibleMenu(menuData) {
        ...
        function subMenuItems(d) {
            ...
            function itemElement(item) {
                ...
                return li(a$1({href:item.href,...aAttrs},item.text));
            }
    ...
    function loremIpsum2(args,pageHash) {
        const { div } = ft.html;
        let resp = div(); 
        resp.innerHTML = `
